(function () {
  ...
  function installOption() {
    ...
    const submit = [...document.querySelectorAll("button")].find(button => /finalizar pedido|finalizando/i.test(button.textContent || ""));
    if (!paymentHeading || !submit) return;
    let wrapper = document.getElementById("emailReceiptPreference");
    if (!wrapper) {
