(() => {
  ...
  function showReceipt(receipt) {
    ...
    const receiptHeader = modal.querySelector("header");
    const receiptLogo = receiptHeader?.querySelector("img");
    if (receiptLogo) { receiptLogo.src = "/assets/logo-termica.png"; receiptLogo.alt = "Gisele Flávia"; }
    receiptHeader?.querySelector("strong")?.remove();
